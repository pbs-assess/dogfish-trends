...
fit_reg <- readRDS("output/fit-trawl-by-region-lognormal-poisson-link.rds")
...
ggsave("figs/coefs-new.pdf", width = 8, height = 5)
...
saveRDS(ret, "output/predicted_depth.rds")
ret <- readRDS("output/predicted_depth.rds")
