...
m <- m |>
  mutate(term2 = c("Intercept", "WCGBT pass 2", "AFSC slope", "AFSC slope early", "NWFSC slope", "Triennial", "Triennial early", "Intercept", "WCGBT pass 2", "AFSC slope", "AFSC slope early", "NWFSC slope", "Triennial", "Triennial early"))

m <- m |>
  mutate(term2 = factor(term2, levels = c("AFSC slope early", "AFSC slope", "NWFSC slope", "Triennial early", "Triennial", "WCGBT pass 2", "Intercept")))
